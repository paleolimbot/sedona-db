...
/// use sedona_geo_generic_alg::{point, polygon};
///
...
pub trait Centroid {
    ...
    /// ```
    /// use sedona_geo_generic_alg::Centroid;
    /// use sedona_geo_generic_alg::{line_string, point};
    ///
    ...
    T: GeoFloat,
{
    ...
    /// ```
    /// use sedona_geo_generic_alg::Centroid;
    /// use sedona_geo_generic_alg::{Line, point};
    ///
    /// let line = Line::new(
    ...
    T: GeoFloat,
{
    ...
    /// ```
    /// use sedona_geo_generic_alg::Centroid;
    /// use sedona_geo_generic_alg::{MultiLineString, line_string, point};
    ///
    ...
    T: GeoFloat,
{
    ...
    /// ```
    /// use sedona_geo_generic_alg::Centroid;
    /// use sedona_geo_generic_alg::{polygon, point};
    ///
    /// let polygon = polygon![
    ///     (x: 0.0f32, y: 0.0),
    ///     (x: 2.0, y: 0.0),
    ...
    T: GeoFloat,
{
    ...
    /// ```
    /// use sedona_geo_generic_alg::Centroid;
    /// use sedona_geo_generic_alg::{MultiPolygon, polygon, point};
    ///
    ...
    T: GeoFloat,
{
    ...
    /// ```
    /// use sedona_geo_generic_alg::Centroid;
    /// use sedona_geo_generic_alg::{Rect, point};
    ///
    /// let rect = Rect::new(
    ...
    TT: TriangleTraitExt<T = T>,
{
    ...
    /// ```
    /// use sedona_geo_generic_alg::Centroid;
    /// use sedona_geo_generic_alg::{Triangle, coord, point};
    ///
    ...
    MP: MultiPointTraitExt<T = T>,
{
    ...
    /// ```
    /// use sedona_geo_generic_alg::Centroid;
    /// use sedona_geo_generic_alg::{MultiPoint, Point};
    ///
    ...
    G: GeometryTraitExt<T = T>,
{
    ...
    /// ```
    /// use sedona_geo_generic_alg::Centroid;
    /// use sedona_geo_generic_alg::{Geometry, Rect, point};
    ///
    /// let rect = Rect::new(
    ///   point!(x: 0.0f32, y: 0.0),
    ///   point!(x: 1.0, y: 1.0),
    ...
    GC: GeometryCollectionTraitExt<T = T>,
{
    ...
    /// ```
    /// use sedona_geo_generic_alg::Centroid;
    /// use sedona_geo_generic_alg::{Geometry, GeometryCollection, Rect, Triangle, point, coord};
    ///
...
impl<T: GeoFloat> CentroidOperation<T> {
        ...
        L: LineTraitExt<T = T>,
    {
        match line.dimensions() {
            ...
            OneDimensional => {
                let weight = line.length_ext(&Euclidean);
                self.add_centroid(OneDimensional, line.centroid().0, weight)
            }
