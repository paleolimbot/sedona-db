...
use crate::index::build_side_collector::BuildSideBatchesCollector;
...
use datafusion_execution::{
    disk_manager::RefCountedTempFile, memory_pool::MemoryReservation, SendableRecordBatchStream,
    TaskContext,
};
...
use sedona_spatial_join::index::build_side_collector::CollectBuildSideMetrics;
use sedona_spatial_join::index::memory_plan::{
    compute_memory_plan, MemoryPlan, PartitionMemorySummary,
};
use sedona_spatial_join::index::spatial_index_builder::SpatialJoinBuildMetrics;
use sedona_spatial_join::partitioning::broadcast::BroadcastPartitioner;
use sedona_spatial_join::partitioning::flat::FlatPartitioner;
use sedona_spatial_join::partitioning::kdb::KDBPartitioner;
use sedona_spatial_join::partitioning::round_robin::RoundRobinPartitioner;
use sedona_spatial_join::partitioning::rtree::RTreePartitioner;
use sedona_spatial_join::partitioning::stream_repartitioner::{
    SpilledPartition, SpilledPartitions, StreamRepartitioner,
};
use sedona_spatial_join::partitioning::{PartitionedSide, SpatialPartition, SpatialPartitioner};
use sedona_spatial_join::probe::partitioned_stream_provider::ProbeStreamOptions;
use sedona_spatial_join::utils::bbox_sampler::BoundingBoxSamples;
...
impl SpatialJoinComponentsBuilder {
    ...
    async fn collect_build_partitions(
        ...
        let builder = Arc::new(GPUSpatialIndexBuilder::new(
...
mod tests {
    ...
    use sedona_spatial_join::partitioning::partition_slots::PartitionSlots;
