...
use sedona_spatial_join::evaluated_batch::spill::{EvaluatedBatchSpillWriter, SpillArtifact};
                ...
                |b, file| {
                    b.iter(|| {
                        runtime.block_on(async {
                            let stream = ExternalEvaluatedBatchStream::try_from_spill_file(
                                SpillArtifact::clone(file),
                            )
